...
import com.ensi.pcd.ourdeal.utilities.UseOnlyPrivateHere;
...
/**
 * Class that represent the tab's list associated to {@link com.ensi.pcd.ourdeal.chatmessages.WiFiChatFragment}
 * <p></p>
 ...
 * {@link com.ensi.pcd.ourdeal.model.P2pDestinationDevice} index.
 * Because the first tab is reserved to {@link com.ensi.pcd.ourdeal.services.WiFiP2pServicesFragment}.
 * <p></p>
...
public class DestinationDeviceTabList {
    ...
    /**
     * Method that sets a {@link com.ensi.pcd.ourdeal.model.P2pDestinationDevice}
     ...
     * @param device {@link com.ensi.pcd.ourdeal.model.P2pDestinationDevice}
    ...
    /**
     * Method to add a {@link com.ensi.pcd.ourdeal.model.P2pDestinationDevice}
    ...
    /**
     * Method that check if a {@link com.ensi.pcd.ourdeal.model.P2pDestinationDevice}
     * is in the {@link #deviceList}.
     * If the device parameter is null, this method returns false!
     * @param device WifiP2p{@link com.ensi.pcd.ourdeal.model.P2pDestinationDevice} element.
    ...
    /**
     * Method to get the index position of a {@link com.ensi.pcd.ourdeal.model.P2pDestinationDevice}
     ...
     * @param device {@link com.ensi.pcd.ourdeal.model.P2pDestinationDevice} element.
