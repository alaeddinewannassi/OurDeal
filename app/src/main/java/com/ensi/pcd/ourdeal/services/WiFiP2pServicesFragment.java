...
package com.ensi.pcd.ourdeal.services;
/*
...
import com.ensi.pcd.ourdeal.AdhocActivity;
import com.ensi.pcd.ourdeal.R;
import com.ensi.pcd.ourdeal.model.LocalP2PDevice;
import com.ensi.pcd.ourdeal.services.localdeviceguielement.LocalDeviceDialogFragment;
 ...
 * If you click on the local device cardview, a {@link com.ensi.pcd.ourdeal.services.localdeviceguielement.LocalDeviceDialogFragment}
...
public class WiFiP2pServicesFragment extends Fragment implements
    ...
    /**
     * Callback interface to call methods tryToConnectToAService in {@link com.ensi.pcd.ourdeal.AdhocActivity}.
    ...
    public void changeLocalDeviceName(String deviceName) {
        ...
        ((AdhocActivity)getActivity()).setDeviceNameWithReflection(deviceName);
    }

    /**
     * Method called by {@link com.ensi.pcd.ourdeal.services.WiFiServicesAdapter}
     * with the {@link com.ensi.pcd.ourdeal.services.WiFiServicesAdapter.ItemClickListener}
     ...
     * It's useful to open the {@link com.ensi.pcd.ourdeal.services.localdeviceguielement.LocalDeviceDialogFragment}
